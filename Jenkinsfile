...
ENVIRONMENT]withScope−>[cap E cap N cap V cap I cap R cap O cap N cap M cap E cap N cap T close bracket w i t h cap S c o p e minus is greater than open bracket
𝐸𝑁𝑉𝐼𝑅𝑂𝑁𝑀𝐸𝑁𝑇]𝑤𝑖𝑡ℎ𝑆𝑐𝑜𝑝𝑒−>[
{TEST_SUITE}]"
}
}
}
